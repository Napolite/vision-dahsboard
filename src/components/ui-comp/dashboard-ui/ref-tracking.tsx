...
function Reftracking() {
  return (
    <div className="text-[white] flex flex-col items-center relative rounded-[20px] from-[#060b2694] from-[0%] to-[#0a0e2349] to-[100%] bg-gradient-to-br py-[20px] px-[20px] w-[551px] h-[344px] backdrop-blur-lg">
