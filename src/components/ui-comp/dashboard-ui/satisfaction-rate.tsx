...
function SatisfactionRate() {
  return (
    <div className="text-[white] flex flex-col items-center relative rounded-[20px] from-[#060b26] from-[0%] to-[#0a0e2349] to-[100%] bg-gradient-to-b py-[20px] px-[20px] w-full backdrop-blur-lg h-[344px]">
      ...
      <div className="flex justify-between bg-[#060B28] px-[20px] py-[10px] w-[90%] m-auto h-[82px] items-start rounded-[20px] absolute bottom-[20px]">
